  ...
  questionsDiv = questions.map((question) => {
    ...
    <div class="question__container">
      ...
      <li class="answer__choice">
        <input type="radio" name="answer" value="${allAnswers[0]}"/>${allAnswers[0]}
      </li>
      <li class="answer__choice">
        <input type="radio" name="answer" value="${allAnswers[1]}"/>${allAnswers[1]}
      </li>
      <li class="answer__choice">
        <input type="radio" name="answer" value="${allAnswers[2]}"/>${allAnswers[2]}
      </li>
      <li class="answer__choice">
        <input type="radio" name="answer" value="${allAnswers[3]}"/>${allAnswers[3]}
      </li>
      </ul>
    </div>
    `;
